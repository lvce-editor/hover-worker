...
export const modules = [DiffEventListeners.isEqual, DiffBounds.isEqual, DiffParentUid.isEqual, DiffFocusContext.isEqual]

export const numbers = [DiffType.RenderEventListeners, DiffType.RenderBounds, DiffType.RenderUid, DiffType.RenderFocusContext]
