...
export const name = 'editor.hover-show-error-thrown'

export const skip = 1

export const test: Test = async ({ Editor, expect, Extension, FileSystem, Locator, Main }) => {
  // arrange
  const url = new URL('../fixtures/editor.hover-show-error-thrown', import.meta.url).toString()
  ...
  // assert - hover should not appear when extension throws error
