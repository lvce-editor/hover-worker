...
export const name = 'editor.hover-show-promise-rejection'

export const test: Test = async ({ Editor, expect, Extension, FileSystem, Locator, Main }) => {
  // arrange
  const url = new URL('../fixtures/editor.hover-show-promise-rejection', import.meta.url).toString()
  ...
  // assert - hover should not appear when extension promise rejects
